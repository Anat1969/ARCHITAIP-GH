export const cultures = [
  {
    ...
    interpretation: 'ה-DNA המסופוטמי מתורגם לעכשווי דרך כובד חומרי מכוון: קירות בטון גולמי עבים שמגנים ולא רק מגדירים, תקרות נמוכות שלוחצות כלפי האדמה, פתחים מינימליים שמאפשרים רק כמה שנדרש. לא קישוט — הכרזה. המרחב הנגזר ממסורת זו יחושב בכובד, בנוכחות ובלחץ גרביטציוני — כי הכאוס עדיין מחכה בחוץ.',
...

  {
    ...
    interpretation: 'ה-DNA המצרי מתורגם לעכשווי דרך חתכי אור מדויקים בתוך מסות כבדות: חריצים אנכיים צרים שמפלחים אור לתוך בטון אפור, פרופורציות שמקטינות את הגוף האנושי בכוונה, ומשטחים חשופים שאינם מרוהטים — תזכורת שהקיום זמני. גדולה אינה יופי, גדולה היא מידה; המרחב המודרני הנגזר ממנה דורש: ראה את זעירותך, ופעל בהתאם.',
...

  {
    ...
    interpretation: 'ה-DNA ההינדי מתורגם לעכשווי דרך שכבות מרקם ואור מפולטר: עורות בטון מחוספסות עם גיאומטריה עדינה, מסכי אבן מחוררות שמפלחות אור לנקודות קדושה, ומסדרות אנכיות המוליכות אל חשיכה מכוונת בפנים. הפנימי ביותר הוא האפל ביותר — שם הנוכחות. המרחב המודרני הנגזר מה-DNA הזה לא מנחם בקלילות, אלא מעמיק ומחשיך בכוונה כדי שהחשוב יבלוט.',
...

  {
    ...
    interpretation: 'ה-DNA הסיני מתורגם לעכשווי דרך חצרות-שמיים וסדר ציר מדויק: קומפוזיציות סימטריות המתארגנות סביב חלל פתוח לשמיים, שערים עגולים שמסגרים נוף כציור, ועץ ואבן בדיאלוג שמממש את הדאו ארכיטקטוני. הסדר אינו שליטה — הוא שיקוף; כל אלמנט יודע את מקומו ביחס לאחרים, כמו בחברה קונפוציאנית מתוכננת היטב.',
...

  {
    ...
    interpretation: 'ה-DNA המאיאני מתורגם לעכשווי דרך מסות מדורגות ויחסי שמש: מבנים טרסיים עולים בבטון חשוף שמחייבים מאמץ גופני לעלייה, פתחים המוצבים ביחס לנתיב השמש שיוצרים אירועי אור בזמנים מוגדרים, ושטחי גג המשמשים פלטפורמות קהילתיות. כל שלב עלייה הוא מחיר — כל קרן שמש היא תאריך; המרחב מודד זמן ומחייב טקס.',
...

  {
    ...
    interpretation: 'ה-DNA הישראלי הקדום מתורגם לעכשווי דרך אבן גולמית ואור-מלמעלה: קירות מאבן ירושלמית לא מלוטשת שנושאת זיכרון, חריצי אור אנכיים מגבוה שמחייבים קשב ולא מנחמים, וספים מוגדרים הדורשים החלטה מודעת לחצות. המרחב לא מספר — הוא שואל. לא מקשט — הוא מחייב. מי שנכנס אליו יוצא עם שאלה שלא הייתה לו לפני.',
...

  {
    ...
    interpretation: 'ה-DNA הזורואסטרי מתורגם לעכשווי דרך ניגוד אור-חושך מוחץ: מרחבי כניסה גבוהים ומוארים המנוגדים לפנים מוצלל יחסית, משטחים מבריקים שמחזירים אור כהצהרת ניצחון, ופרופורציות אימפריאליות שמכריזות עמדה לפני שנכנסים. הבנייה בוחרת צד — אין ניטרלים. המרחב המודרני הנגזר ממנה מחייב את הנכנס להצהיר: פה אתה בטוב.',
...

  {
    ...
    interpretation: 'ה-DNA היווני הקלאסי הוא שורש הרציונליזם האדריכלי: קצבי עמודים שמגדירים מרחב בלי לסגור אותו, יחסי פרופורציה הנגזרים מהגוף האנושי, וצללים מדויקים הנוצרים מאנטבלמנטים ישרים. המרחב המודרני הנגזר ממנה מגדיר אתיקה בטון: כל אלמנט מוצדק, כל גבול מוסבר, כל פרופורציה מוכיחה שסדר אפשרי — ולכן אפשר לדרוש אותו גם מהאדם.',
...

  {
    ...
    interpretation: 'ה-DNA הקלטי מתורגם לעכשווי דרך גבולות מטושטשים וחומרים שהטבע אוכל בחזרה: קירות בזלת מחוספסת עם כיסוי אזוב, מעברים שלא ברור מתי פנים ומתי חוץ, ופתחים שנקבעו ביחס לנוף ולא לרחוב. קדושת הסף — לא הפנים — היא הגדרת המרחב; המרחב המודרני הנגזר ממנה מזמין את הטבע להשלים את הבנייה, לא לנגד אותה.',
...

  {
    ...
    interpretation: 'ה-DNA היפני השינטואיסטי הוא ההורה הישיר של המינימליזם המודרני: מרחב מא — החלל הריק כנושא האדריכלי — עץ הינוקי ואבן בדיאלוג עדין, לוחות שוג\'י שמפזרים אור בשווה ובלי כיוון, וכל אלמנט נושא כוונה מלאה או נעדר לגמרי. כאשר הרעש האנושי נעלם מהמרחב — הרוחות נוכחות; זה הפרויקט המודרני שנגזר ממנה: שקט כפרויקט.',
...

  {
    ...
    interpretation: 'ה-DNA האפריקאי אובונטו מתורגם לעכשווי דרך חלל מרכזי ריק כלב המתחם: חצרות קהילתיות מוקפות בנפחים הפונים פנימה, חומרים טיט-ועץ הגרועים בטקסטורות ארץ, ושמיים פתוחים כתקרה משותפת שלא שייכת לאיש ולכולם. הבית לא שייך לפרט — הוא אמצע; המרחב המודרני הנגזר ממנו שם את החלל המשותף קודם, ואת הפרטי בשירותו.',
